...
class PerroController
{
    ...
    public function alta()
    {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            // Guardar los coches en la base de datos
    ...
    public function baja($id)
    {
            ...
            if ($perro !== null) {
                // Elimina el coche del array local
                
                // Llama al método para eliminar el coche de la base de datos
    ...
    public function actualizar($id)
{
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // Busca el coche existente y lo actualiza
        foreach ($this->perros as &$guau) {
            if ($guau->getId() == $id) {
